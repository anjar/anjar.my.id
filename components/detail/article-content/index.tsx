...
const DetailArticleContent: FunctionComponent<Props> = ({ article }: Props) => {
  ...
  return (
    <article>
      <div>
        <h1 className="mb-4 text-2xl font-bold tracking-tight text-black md:text-5xl dark:text-white leading-none">
          {article?.title}
        </h1>
      </div>
        ...
        <div className="col-span-6">
          <div className="md:flex-shrink-0">
            <div className="flex justify-between text-md text-gray-500 mb-2">
              ...
              <div>
                <span className="">{article.readingTime.text} • xxx views</span>
              </div>
            </div>
        ...
        <div className="hidden md:block md:col-span-2">
          <div className="sticky top-20">
            <div className="flex flex-wrap gap-2">
              <FacebookShareButton url={detailURL} quote={article.title}>
                <FacebookIcon size="2.2rem" round />
              </FacebookShareButton>
              <TwitterShareButton url={detailURL}>
                <TwitterIcon size="2.2rem" round />
              </TwitterShareButton>
              <LinkedinShareButton url={detailURL}>
                <LinkedinIcon size="2.2rem" round />
              </LinkedinShareButton>
              <WhatsappShareButton url={detailURL}>
