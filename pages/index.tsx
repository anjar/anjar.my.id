  ...
  return <>
    ...
    <section className="mt-6 mb-8">
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
        ...
        <Link
          href="/article"
          className="flex leading-7 rounded-lg  hover:text-sky-800 transition-all h-6">
          Read all posts<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" className="h-6 w-6 ml-1"><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.5 12h-15m11.667-4l3.333 4-3.333-4zm3.333 4l-3.333 4 3.333-4z"></path></svg>
        </Link>
      </div>
    ...
    <section className="mt-6 mb-6">
      <h3 className="mb-4">
        <Link href="/work" className="text-2xl font-bold hover:text-sky-800">
